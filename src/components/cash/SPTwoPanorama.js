...
class SPTwoPanorama extends Component {
    state={
        userName: '',
        client: {},
    ...
    dbFormCash = ref.child('FormCajaPP/-LWRAsQvmr_nNPP5dygO');
    dbCashRoom = ref.child('CashRoomPP/-KJADOAJSDOJ1');
    dbSpecialCash = ref.child('SpecialCashPP/-LAOP22KwSD-adSD2');
