...
class SPTwoCapital extends Component {
    state={
        userName: '',
        client: {},
    ...
    dbFormCash = ref.child('FormCaja/-LWRAsQvmr_nNPP5dygO');
    dbCashRoom = ref.child('CashRoom/-KJADOAJSDOJ');
    dbSpecialCash = ref.child('SpecialCash/-LAOP22KwSD-adSD');
